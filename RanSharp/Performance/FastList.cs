...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        #region Constructors
        /// <summary>
        /// Initializes a new instance of the <see cref="FastList{T}"/> class that is empty and has the default initial capacity.
        /// </summary>
        public FastList() { _items = _emptyArray; }
        /// <summary>
        /// Initializes a new instance of the <see cref="FastList{T}"/> class that is empty and has the specified initial capacity.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FastList{T}"/> class that contains elements copied from the specified <see cref="IEnumerable{T}"/> and has sufficient capacity to accommodate the number of elements copied.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FastList{T}"/> class that contains elements copied from the specified <typeparamref name="T"/>[] and has sufficient capacity to accommodate the number of elements copied.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FastList{T}"/> class that has the specified initial capacity and each element is generated by the specified generator.
        /// </summary>
